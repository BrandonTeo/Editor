...
public class SingleLetterDisplaySimple extends Application {
    ...
    private class KeyEventHandler implements EventHandler<KeyEvent> {
        ...
        private Text displayText2 = new Text(STARTING_TEXT_POSITION_X, STARTING_TEXT_POSITION_Y, "");
        ...
        KeyEventHandler(final Group root, int windowWidth, int windowHeight) {
            ...
            displayText2 = new Text(textCenterX, textCenterY, "");
        ...
        public void handle(KeyEvent keyEvent) {
            if (keyEvent.getEventType() == KeyEvent.KEY_TYPED) {
                ...
                if (characterTyped.length() > 0 && characterTyped.charAt(0) != 8) {
                    ...
                    displayText2.setText(characterTyped);
                    keyEvent.consume();
                }
        ...
        private void centerText() {
            ...
            displayText2.setX(textLeft + 7);
            displayText2.setY(textTop);

            // Make sure the text appears in front of any other objects you might add.
            //displayText.toFront();
            //displayText2.toFront();
        }
    }
